...
class ArrayMatrixTest extends AnyFunSuite {
  ...
  test("multiply") {
    val matrix1: ArrayMatrix[Int] = ArrayMatrix.from(Array(
      Array(1, 0, 5, 6),
      Array(0, 2, 4, 7),
      Array(7, 8, 0, 8),
    ))

    val matrix2: ArrayMatrix[Int] = ArrayMatrix.from(Array(
      Array(2, 3, 9, 8, 7),
      Array(5, 3, 4, 5, 6),
      Array(9, 4, 0, 2, 4),
      Array(8, 6, 7, 5, 3),
    ...
    val productMatrix: ArrayMatrix[Int] = ArrayMatrix.from(Array(
  ...
  test("addition"){
    ...
    val additionMatrix: ArrayMatrix[Int] = ArrayMatrix.from(Array(
      Array(3, 3, 14, 14),
      Array(5, 5, 8, 12),
      Array(16, 12, 0, 10),
    ))
